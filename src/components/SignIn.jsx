    ...
    <div className="auth-container" id="signin">
      <div className="auth-content">
        ...
        <form onSubmit={(e) => e.preventDefault()}>
          ...
          <button type="submit" className="white-btn" onClick={() => alert('This button should connect to backend authentication (e.g., Google, Apple, Email)')}>
            Sign in
          </button>
        </form>
